...
class Nextpay_Payment
{
    ...
    public $trans_id = "";
    public $params = array();
    public $server_soap = "http://api.nextpay.org/payment/verify.wsdl";
    //public $server_soap = "http://api.nextpay.org/payment/verify?wsdl";
    public $server_http = "http://api.nextpay.org/payment/verify.http";
    public $request_http = "http://api.nextpay.org/payment/request.http";
    public $request_verify_soap = "http://api.nextpay.org/payment/request_verify.wsdl";
    //public $request_verify_soap = "http://api.nextpay.org/payment/request_verify?wsdl";
    public $request_verify_http = "http://api.nextpay.org/payment/request_verify.http";
        ...
        switch ($this->default_verify)
        {
            case Type_Verify::SoapClient:
                try
                {
                    ...
                    $res = $soap_client->verify($this->params);
            ...
            case Type_Verify::NuSoap:
                try
                {
                    ...
                    $res = $client->call('verify',array($this->params));
                    ...
                    else
                    {
                        ...
                        if ($res != "" && $res != NULL) {
                            ...
                            if (strpos($res, ',') !== false)
                                $this->trans_id = explode(',', $res['verifyResult'])[0];
                            else
                                $this->code_error($res);
                        }
                    }
        ...
        switch ($this->default_verify)
        {
            case Type_Verify::SoapClient:
                try
                {
                    ...
                    $res = $soap_client->request_verify($this->params);

                    $res = $res->request_verifyResult;
            ...
            case Type_Verify::NuSoap:
                try
                {
                    ...
                    $res = $client->call('request_verify',array($this->params));
